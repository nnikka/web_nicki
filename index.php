            ...
            <header>
                <div id="particles">
                  <div id="intro">
                    ...
                    <div class="row margin-top-60px header-cont header-cont">
                        ...
                        <a href="#section-motivation" class="btn hvr-bounce-in english-lang-btn">-CONTINUE-</a>
                        <a href="#section-motivation" class="btn hvr-bounce-in georgian-lang-btn">-gaagrZele-</a>
                    </div>
                  </div>
                </div>
            </header>

            <section id="section-motivation" class="my-mot">
                ...
                <div class="row">
                    <p class="mot-contetnt">That's right! I love to create and upgrade awesome website. I am technicaly proficient, easy to work with and i don't stop till it's pertfect. So what ar you waiting for?</p>
                   <div class="row margin-top-40px">
                         <a href="moreInfo.php#how-works" class="btn-def hvr-bounce-in english-lang-btn">-MORE INFO-</a>
                    </div>
                </div>
